 ...
 * graph.Dijkstra's algorithm will assign some initial distance values and will try to improve them step by step.
 *
...
public class Dijkstra {
    private static class Graph{
        private static class Node{
            ...
            private Node(String vertex, int value, Edge firstEdge){
                this.vertex = vertex;
                this.value = value;
    ...
    public static void main(String[] args) {
        ...
        //graph.nodes = Collections.unmodifiableList(new ArrayList<>(9));
        //Graph.Node aNode = new Graph.Node("A", 0, null);
    }
}
